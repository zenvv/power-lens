...
export const es = {
  ...
  home: {
    ...
    diagramOutcomeLabel: "Contenido legible",
    diagramOutcomeAlt:
      "Ilustración que representa el archivo convertido en contenido legible",
  ...
  sidebarFooter: {
    ...
    rules: "Reglas de health check",
    language: "Idioma",
    languageNames: { en: "Inglés", pt: "Portugués", es: "Español" },
    theme: "Tema",
    themeLight: "Claro",
    themeDark: "Oscuro",
    themeSystem: "Sistema",
    githubLink: "Power Lens en GitHub",
  },
  ruleConfig: {
    title: "Reglas de health check",
    description: "Apaga una regla, o ajusta su umbral, sin tocar el archivo — el cambio vale desde el próximo análisis del documento.",
  ...
  search: {
    title: "Buscar",
    placeholder: "Buscar pantallas, controles, fuentes de datos, flujos, tablas...",
  ...
  lineage: {
    noReport: "Ningún informe asociado a este modelo — el lineage necesita el Report/Layout de un .pbit para saber qué visuales usan cada columna.",
    unusedCount: (p: { count: number }) => `${p.count} sin usar`,
    onlyUnusedToggle: "Solo sin usar",
    kindMeasure: "medida",
    kindColumn: "columna",
  ...
  diff: {
    compareTrigger: "Comparar con otro archivo",
    compareDialogTitle: "Comparar con otro archivo",
    compareDialogDescription: "Suelta un segundo archivo del mismo tipo — la comparación empareja artefactos por nombre, no por id interno, así que funciona entre dos exportaciones independientes.",
    compareErrorTitle: "No se pudo comparar",
    compareError: "No se pudo reconocer o procesar el segundo archivo.",
    title: "Comparación",
    back: "Volver",
    comparing: (p: { fileNameA: string; fileNameB: string }) => `${p.fileNameA} vs. ${p.fileNameB}`,
    noDifferences: "No se encontraron diferencias entre los dos archivos.",
    statusLabel: {
      added: "agregado",
      removed: "eliminado",
      changed: "cambiado",
